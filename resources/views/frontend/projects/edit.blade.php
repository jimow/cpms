                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.projects.update", [$project->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="details" id="details" value="{{ old('details', $project->details) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="budget" id="budget" value="{{ old('budget', $project->budget) }}">
