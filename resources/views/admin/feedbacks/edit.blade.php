    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.feedbacks.update", [$feedback->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contact') ? 'is-invalid' : '' }}" type="text" name="contact" id="contact" value="{{ old('contact', $feedback->contact) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('feedback') ? 'is-invalid' : '' }}" name="feedback" id="feedback">{!! old('feedback', $feedback->feedback) !!}</textarea>
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('admin.feedbacks.storeCKEditorImages') }}', true);
